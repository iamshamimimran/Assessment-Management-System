...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($lastInsertId) {
            $msg = "Your information added successfully";
        } else {
                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Apply Student Assessment</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Apply For Assessment</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <?php if ($msg) { ?>
                                                <div class="alert alert-success left-icon-alert" role="alert">
                                                    <strong>Well done!</strong><?php echo htmlentities($msg); header("location: student-added.php")?>
                                            ...
                                            <form class="form-horizontal" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Class/Assessment</label>
                                                    <div class="col-sm-10">
